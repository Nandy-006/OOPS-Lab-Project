...
public class PhoneAuthActivity extends AppCompatActivity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Toast.makeText(getApplicationContext(), "Entered Oncreate 1", Toast.LENGTH_LONG).show();
		...
		Intent getphno = getIntent();
		String phno = getphno.getStringExtra("phno");
		mPhoneNumberField.setText("+91".concat(phno));
